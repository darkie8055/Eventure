...
interface SignupFormProps {
  onSignup?: (data: StudentSignupData | CommunityLeadSignupData, role: 'student' | 'community_lead') => void;
}
            ...
            <TabsContent value="community_lead">
              <Form {...leadForm}>
                <form onSubmit={leadForm.handleSubmit(handleLeadSubmit)} className="space-y-4">
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <div className="relative">
                              ...
                              <Input placeholder="e.g., IEEE, CSI" className="pl-10" {...field} />
                            </div>
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                  ...
                  <Button type="submit" className="w-full" disabled={isLoading}>
                    {isLoading ? "Submitting Application..." : "Apply as Community Lead"}
                  </Button>
                </form>
              </Form>
            </TabsContent>
